...
/*   Updated: 2023/05/01 19:31:18 by ebennix          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_componets(t_data *map_data)
{
	map_data->componets.player = mlx_xpm_file_to_image(map_data->mlx,
			"textures/player/player.xpm", &map_data->componets.img_width,
			&map_data->componets.img_height);
	map_data->componets.exit = mlx_xpm_file_to_image(map_data->mlx,
			"textures/exit/exit.xpm", &map_data->componets.img_width,
			&map_data->componets.img_height);
	map_data->componets.collectible = mlx_xpm_file_to_image(map_data->mlx,
			"textures/collectible/coin.xpm", &map_data->componets.img_width,
			&map_data->componets.img_height);
