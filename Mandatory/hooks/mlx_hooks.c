...
/*   Updated: 2023/05/09 19:13:26 by ebennix          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	move(t_data *game, unsigned int x, unsigned int y)
{
	...
	map = game->map;
	if (map[game->p_pos.x + x][game->p_pos.y + y] == '0' ||
			map[game->p_pos.x + x][game->p_pos.y + y] == 'P')
	{
		game->moves++;
		game->p_pos.x += x;
		game->p_pos.y += y;
	}
	else if (map[game->p_pos.x + x][game->p_pos.y + y] == 'C')
	{
		game->moves++;
